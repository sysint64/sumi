...
impl State {
    pub async fn new(window: Arc<Window>) -> anyhow::Result<Self> {
        ...
        // let gapi = unsafe { sumi::Graphics::new_in_pool(gapi_params) };
        let mut gapi = sumi::Graphics::new(gapi_params);
    ...
    pub fn resize(&mut self, width: u32, height: u32) {
        ...
        self.gapi.set_view_size(view_size);
    }
...
struct Renderers {
    colored_plane: sumi::ColoredPlaneRenderer<sumi::CenteredPlaneResources>,
...
impl RenderDemoRenderer<'_> {
    fn new(context: &mut sumi::GraphicsContext<'_, '_>, view: &sumi::GraphicsView) -> Self {
        ...
        state.demo_text =
            resources
                .text
                .add_text(view.scale_factor, &mut fonts, 20., 20., |_, text| {
        ...
        state.fps_text =
            resources
                .text
                .add_text(view.scale_factor, &mut fonts, 14., 14., |_, text| {
        ...
        resources
            .sin_wave
            .set_line_width(5. * view.scale_factor_f32);

        resources
            .small_grid
            .set_line_width(1. * view.scale_factor_f32);
        resources
            .big_grid
            .set_line_width(5. * view.scale_factor_f32);
...
fn update(view: &sumi::GraphicsView, state: &mut RenderDemoState) {
    ...
    let transforms = sumi::Transforms2D {
        ...
        scaling: Vec2::new(
            430. * view.scale_factor_f32 * 0.8,
            600. * view.scale_factor_f32 * 0.8,
        ),
    ...
    let transforms = sumi::Transforms2D {
        position: Vec2::new(
            20. * view.scale_factor_f32 + rr_size.x / 2.,
            view.size.y - 20. * view.scale_factor_f32 - rr_size.y / 2.,
        ),
        scaling: rr_size,
        rotation: 0.,
    };
...
fn render_demo(
    ...
    renderers.colored_plane_instances.clear();
    renderers
        .colored_plane_instances
    ...
    renderers.colored_plane_instances.upload_all(context);
    renderers.colored_plane.render_all(
        context,
        &resources.centered_plane,
        &mut renderers.colored_plane_instances,
    );
