...
//             colored_plane: sumi::ColoredPlaneRenderer::new(context, sumi::Instances::new(10)),
...
//         renderers.colored_plane.instances().upload_all(context);
...
//     renderers.colored_plane.instances().update(
//         state.quad_instance_id,
...
//         .colored_plane
//         .instances()
//         .upload_slot(context, state.quad_instance_id);
